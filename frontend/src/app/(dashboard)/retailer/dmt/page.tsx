...
const SEARCH_INPUT_SX = {
  ...
  "& .MuiOutlinedInput-root": {
    ...
    fontWeight: 600,
    color: TEXT_PRIMARY,
    "& fieldset": { borderColor: BORDER_GLASS, borderWidth: "1px" },
  ...
  "& .MuiInputLabel-root": { color: TEXT_SECONDARY, fontWeight: 600, fontSize: "14px" },
  "& .MuiInputLabel-root.Mui-focused": { color: PRIMARY_BLUE, fontWeight: 700 },
  "& .MuiInputBase-input::placeholder": { color: TEXT_SECONDARY, opacity: 1, fontSize: "14px" },
};
