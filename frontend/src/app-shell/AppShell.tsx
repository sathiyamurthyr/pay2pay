...
export const AppShell: React.FC<AppShellProps> = ({
  ...
  // Compute responsive layout dimensions
  ...
  const activeSidebarWidth = isCollapsed ? "72px" : dimensions.sidebarWidth;
  ...
  return (
    <Box
      sx={{
        ...
        gridTemplateRows: "72px minmax(0, 1fr) 64px",
        overflow: "hidden",
        position: "fixed",
        top: 0,
        left: 0,
    ...
    >
      ...
      {/* FOOTER AREA */}
      <Box sx={{ gridArea: "footer", width: "100%", zIndex: 1100 }}>
