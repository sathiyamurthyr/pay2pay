                ...
                <Stack spacing={1.2}>
                  ...
                  <Button
                    ...
                    sx={{
                      ...
                      textTransform: "none",
                      borderRadius: "10px",
                      color: status === "FAILED" ? "#DC2626" : "#4F46E5",
                      borderColor: status === "FAILED" ? "#FCA5A5" : "#C7D2FE",
                      bgcolor: status === "FAILED" ? "#FEF2F2" : "#EEF2FF",
                      "&:hover": {
                        borderColor: status === "FAILED" ? "#EF4444" : "#6366F1",
                        bgcolor: status === "FAILED" ? "#FEE2E2" : "#E0E7FF",
                      },
                    }}
                  >
