...
async def get_admin_operation_wallets(
    ...
    ).order_by(AdminServiceVendorWalletModel.service_code.asc(), AdminServiceVendorVendor_name.asc() if hasattr(AdminServiceVendorWalletModel, "vendor_name") else AdminServiceVendorWalletModel.id.asc())
