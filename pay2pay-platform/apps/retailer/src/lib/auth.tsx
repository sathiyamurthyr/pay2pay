      ...
      try {
        ...
        if (storedUser) {
          ...
          setUser({
            ...
            tenant_id: (typeof window !== "undefined" ? localStorage.getItem("p2p_tenant_id") : null) || undefined,
            roles: ["RETAILER"],
    ...
    try {
      ...
      if (data?.access_token) {
        ...
        const userData = data.user || {
          ...
          tenant_id: data.tenant_id || (typeof window !== "undefined" ? localStorage.getItem("p2p_tenant_id") : null) || undefined,
          roles: ["RETAILER"],
