...
export default function AdminTopupRequestsPage() {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      if (res.data?.success) {
        setActionSuccessMsg(
          `Successfully approved & credited ₹${amount.toLocaleString("en-IN", { minimumFractionDigits: 2 })} to ${
          ...
          <table className="w-full text-left text-xs text-slate-700">
            <thead className="bg-slate-50/90 text-slate-700 uppercase font-black text-[11px] tracking-wider border-b border-slate-200">
              <tr>
                ...
                <th className="py-3.5 px-4 text-right font-black">REQUESTED AMT</th>
                <th className="py-3.5 px-4 text-right font-black">APPROVED AMT</th>
                <th className="py-3.5 px-4 font-black">PAYMENT DETAILS</th>
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4 text-right font-black">
                        {item.approved_amount !== undefined && item.approved_amount !== null ? (
                          <span className="text-emerald-700 text-sm bg-emerald-50 px-2.5 py-1 rounded-lg border border-emerald-200">
                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex items-center gap-1.5 font-medium text-slate-700">
                          ...
                          <span
                            className="font-mono text-slate-800 truncate max-w-[150px] font-bold"
                      ...
                      <div className="p-4 rounded-2xl bg-emerald-50/50 border border-emerald-200 shadow-xs space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-[10px] text-slate-600 font-medium">
                            Requested: <strong className="text-slate-900">₹{selectedRequest.requested_amount.toLocaleString("en-IN")}</strong>
                          </span>
                        </div>
                        ...
                        <div className="pt-2 border-t border-slate-200">
                          ...
                          <div className="grid grid-cols-3 gap-2 text-center">
                            ...
                            <div className="p-2 rounded-xl bg-emerald-50 border border-emerald-200">
                              <span className="text-[10px] text-emerald-700 block font-bold">+ Credit</span>
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-1">
                      {selectedRequest.approved_by && (
                        <div>
                          ...
                          <span className="font-bold text-emerald-700">{selectedRequest.approved_by}</span>
                        </div>
                      )}
                      ...
                      {selectedRequest.rejected_by && (
                        <div>
                          ...
                          <span className="font-bold text-rose-700">{selectedRequest.rejected_by}</span>
                        </div>
                      )}
                      ...
                      {selectedRequest.rejection_reason && (
                        <div className="col-span-2">
                          ...
                          <span className="font-bold text-rose-700">{selectedRequest.rejection_reason}</span>
                        </div>
                      )}
                      {selectedRequest.transaction_reference && (
                        <div className="col-span-2 font-mono">
                          ...
                          <span className="font-bold text-emerald-800">{selectedRequest.transaction_reference}</span>
                        </div>
                      )}
                    </div>
                  </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 w-full max-w-md bg-white border border-slate-200 rounded-3xl p-6 shadow-2xl space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div>
                <label className="block text-slate-700 font-bold mb-1">Approval Amount (INR)</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    value={customApprovedAmount}
                    onChange={(e) => setCustomApprovedAmount(e.target.value)}
                    className="w-full pl-8 pr-4 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-sm font-black text-slate-900 focus:bg-white focus:outline-none focus:border-emerald-500"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 bg-slate-50 border border-slate-300 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:bg-white focus:outline-none focus:border-emerald-500 h-20 resize-none"
                />
              </div>
