...
export default function RetailerLoginPage() {
  return (
    <main className="w-full h-screen max-h-screen overflow-hidden bg-slate-950 text-slate-50 font-sans antialiased flex flex-col lg:flex-row 2xl:max-w-[2560px] 2xl:mx-auto">
