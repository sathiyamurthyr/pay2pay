...
export default function BeneficiaryDashboardRedirectPage() {
      ...
      <div className="p-8 rounded-3xl bg-amber-500/10 dark:bg-amber-950/30 border border-amber-500/30 text-slate-900 dark:text-white space-y-6 text-center shadow-xl">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-extrabold tracking-tight">
            Beneficiary Dashboard Moved to Customer 360° Workspace
          </h2>
          <p className="text-xs text-slate-600 dark:text-slate-400 font-medium">
            Beneficiary analytics and management are strictly scoped per customer inside the Customer 360° Workspace.
          </p>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-xs font-semibold text-amber-800 dark:text-amber-300 text-left flex items-start gap-3">
          ...
          <div>
            <strong>Architecture Rule:</strong> Access customer-owned beneficiaries via Customer Directory -&gt; Select Customer -&gt; Customer Workspace -&gt; Beneficiaries Tab.
          </div>
        </div>
