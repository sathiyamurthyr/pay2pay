...
app.include_router(dashboard.router, prefix=f"{settings.API_V1_STR}/api/v1")
app.include_router(organization.router, prefix=settings.API_V1_STR)
app.include_router(organization.router, prefix="/v1")
app.include_router(organization.router, prefix=f"{settings.API_V1_STR}/api/v1")
app.include_router(organization.router, prefix="/api")
app.include_router(organization.router, prefix="")

app.include_router(retailers.router, prefix=settings.API_V1_STR)
app.include_router(retailers.router, prefix="/v1")
app.include_router(retailers.router, prefix=f"{settings.API_V1_STR}/api/v1")
app.include_router(retailers.router, prefix="/api")
app.include_router(retailers.router, prefix="")
...
app.include_router(admin_verification_router.router, prefix="/v1")
app.include_router(admin_verification_router.router, prefix=f"{settings.API_V1_STR}/api/v1")
app.include_router(admin_verification_router.router, prefix="/api")
app.include_router(admin_verification_router.router, prefix="")
...
app.include_router(admin_retailer_controller.router, prefix="/v1")
app.include_router(admin_retailer_controller.router, prefix=f"{settings.API_V1_STR}/api/v1")
...
from app.presentation.api.v1 import enterprise_transaction_report_router
from app.presentation.api.v1 import admin_payout_slabs_router

app.include_router(enterprise_transaction_report_router.router, prefix=settings.API_V1_STR)
app.include_router(enterprise_transaction_report_router.router, prefix="/api")
app.include_router(enterprise_transaction_report_router.router, prefix="")
...
app.include_router(admin_payout_slabs_router.router, prefix=settings.API_V1_STR)
app.include_router(admin_payout_slabs_router.router, prefix="/api")
app.include_router(admin_payout_slabs_router.router, prefix="")
...
from app.presentation.api.v1 import pos_mdr_router
app.include_router(pos_mdr_router.router, prefix=settings.API_V1_STR)
app.include_router(pos_mdr_router.router, prefix="/v1")
app.include_router(pos_mdr_router.router, prefix=f"{settings.API_V1_STR}/api/v1")
...
from app.presentation.api.v1 import admin_favorites_router
app.include_router(admin_favorites_router.router, prefix=settings.API_V1_STR)
app.include_router(admin_favorites_router.router, prefix="/v1")
