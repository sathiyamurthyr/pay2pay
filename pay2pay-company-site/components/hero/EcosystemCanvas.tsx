...
export const EcosystemCanvas: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[360px] sm:h-[420px] lg:h-[480px] rounded-3xl glass-panel p-2 overflow-hidden flex items-center justify-center">
      <canvas ref={canvasRef} className="w-full h-full block" />
      {/* Overlay Status Badge */}
      <div className="absolute top-4 left-4 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-950/80 border border-blue-800/60 backdrop-blur-md">
        <div className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
        <span className="text-[11px] font-bold text-slate-200 tracking-wide">
          Multi-Rail Interoperability
        </span>
      </div>
      <div className="absolute bottom-4 right-4 text-[10px] font-medium text-slate-500 bg-slate-950/60 px-2.5 py-1 rounded-md border border-slate-800/60">
