...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-20 lg:py-28 2xl:py-36 relative bg-[#060D18]/70 border-t border-slate-800/70">
      <div className="max-w-[1920px] 2xl:max-w-[2200px] 3xl:max-w-[2600px] 4k:max-w-[3200px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 3xl:px-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 2xl:gap-16 3xl:gap-24 items-center">
