...
export const siteConfig: SiteConfig = {
  ...
  ecosystem: {
    ...
    subtitle:
      "A connected partner ecosystem designed to support secure digital financial service operations.",
    steps: [
      {
        step: "01",
        title: "Customer",
        description: "Customers access supported financial and utility services through Pay2Pay partners.",
        iconName: "UserCheck",
      },
      {
        step: "02",
        title: "Retailer",
        description: "Retailers provide digital financial services to customers through their Pay2Pay workspace.",
        iconName: "Store",
      },
      {
        step: "03",
        title: "Distributor",
        description: "Distributors support and manage their assigned retailer network.",
        iconName: "Users",
      },
      {
        step: "04",
        title: "Super Distributor",
        description: "Super Distributors manage distributor and retailer operations across their assigned network.",
        iconName: "Network",
      },
      {
        step: "05",
        title: "DIT",
        description: "Access DIT operational services and technical network facilitation.",
        iconName: "Layers",
      },
      {
        step: "06",
        title: "Pay2Pay Core",
        description: "Pay2Pay provides the technology, transaction processing and operational infrastructure connecting the partner ecosystem.",
        iconName: "Cpu",
      },
      {
        step: "07",
        title: "Banking & Service Partners",
        description: "Supported services are processed through authorized banking and service integrations.",
        iconName: "Landmark",
      },
    ],
  },
  workflow: {
    ...
    subtitle: "A connected partner ecosystem designed to support secure digital financial service operations.",
    steps: [
      {
        number: "01",
        title: "Customer",
      ...
      {
        number: "05",
        title: "Pay2Pay Platform",
        description: "Pay2Pay provides the technology, transaction processing and operational infrastructure connecting the partner ecosystem.",
        badge: "Platform",
      },
      {
        number: "06",
        title: "Service / Banking Partners",
        description: "Supported services are processed through authorized banking and service integrations.",
        badge: "Integration",
      },
    ],
    ...
    pillars: [
      {
        ...
        description: "Protect access to Pay2Pay workspaces through controlled authentication.",
        iconName: "ShieldCheck",
        badge: "Controlled Auth",
      },
      {
        title: "Role-Based Access",
        description: "Provide access based on the user's assigned role and permissions.",
        iconName: "Key",
        badge: "RBAC Controls",
      },
      {
        title: "KYC & Verification",
        description: "Support structured partner onboarding and verification workflows.",
        iconName: "FileCheck",
        badge: "Paperless KYC",
      },
      {
        title: "Transaction Controls",
        description: "Apply controlled access to financial operations and transaction activities.",
        iconName: "Activity",
        badge: "Risk Controls",
      },
      {
        title: "Audit & Monitoring",
        description: "Maintain operational visibility and audit information across supported activities.",
        iconName: "FileSpreadsheet",
        badge: "Audit Logs",
      },
      {
        title: "Data Protection",
        description: "Protect sensitive information through secure application and storage practices.",
        iconName: "Lock",
  ...
  rolePortals: [
    {
      ...
      description: "Access the Pay2Pay Retailer Workspace.",
      features: [
    ...
    },
    {
      ...
      description: "Manage assigned retailer operations.",
      features: [
      ...
      getUrl: () => process.env.NEXT_PUBLIC_DIT_LOGIN_URL || "/distributor/login",
    },
    {
      ...
      description: "Manage distributor and retailer network operations.",
      features: [
      ...
      getUrl: () => process.env.NEXT_PUBLIC_SD_LOGIN_URL || "/super-distributor/login",
    },
    {
      id: "dit",
      title: "DIT",
      ...
      description: "Access DIT operational services.",
      features: [
      ...
      ctaLabel: "DIT Login",
      getUrl: () => process.env.NEXT_PUBLIC_DIT_PORTAL_URL || "/dit-dashboard",
    },
    {
      id: "admin",
      title: "Company Admin",
      ...
      description: "Manage enterprise configuration, verification and platform operations.",
      features: [
      ...
      getUrl: () => process.env.NEXT_PUBLIC_ADMIN_LOGIN_URL || "/admin/login",
    },
  ],
  about: {
