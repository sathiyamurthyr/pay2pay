...
export const metadata: Metadata = {
  title: "Privacy Policy | Pay2Pay Enterprise FinTech",
  description:
    "Learn how Pay2Pay collects, safeguards, and processes partner data in compliance with Indian Information Technology regulations.",
};
