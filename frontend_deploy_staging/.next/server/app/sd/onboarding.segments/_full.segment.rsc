...
7:["$","$1","c",{"children":[["$","div",null,{"className":"min-h-screen bg-[#0B0F19] text-white py-8 px-4 sm:px-6 lg:px-8","children":["$","div",null,{"className":"max-w-4xl mx-auto space-y-6","children":[["$","div",null,{"className":"text-center space-y-2","children":[["$","div",null,{"className":"inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-bold","children":"Super Distributor Portal"}],["$","h1",null,{"className":"text-2xl sm:text-3xl font-extrabold tracking-tight","children":"Pay2Pay SD Onboarding"}],["$","p",null,{"className":"text-xs sm:text-sm text-slate-400 max-w-lg mx-auto","children":"Complete your Super Distributor enterprise verification to activate your regional master console."}]]}],["$","$L10",null,{"appType":"SD"}]]}]}],[["$","script","script-0",{"src":"/_next/static/chunks/2wthyjpyhycgb.js","async":true,"nonce":"$undefined"}],["$","script","script-1",{"src":"/_next/static/chunks/38x6w9al48ke9.js","async":true,"nonce":"$undefined"}]],["$","$L11",null,{"children":["$","$12",null,{"name":"Next.MetadataOutlet","children":"$@13"}]}]]}]
14:[]
8:"$W14"
